...
export default class Panel extends Component {
  ...
  render() {
    return (
      <div className="panel-section" id="portfolio">
      <main>
			...
			<div className="slideshow">
				<div className="slide">
					<div className="slide__img-wrap">
						<div className="slide__img img1"></div>
						<div className="slide__img-reveal"></div>
					</div>
					<div className="slide__title-wrap">
						<h3 className="slide__title"><div className="slide__box"></div><span className="slide__title-inner">Hive-coop</span></h3>
						<h4 className="slide__subtitle"><div className="slide__box"></div><span className="slide__subtitle-inner">Made at Hive</span></h4>
                        <Link className="slide__explore"  to="/hive">
                        <span className="slide__explore-inner">Explore</span>
                        </Link>
					</div>
				...
				<div className="slide">
					<div className="slide__img-wrap">
						<div className="slide__img img2"></div>
						<div className="slide__img-reveal"></div>
					</div>
					<div className="slide__title-wrap">
						<h3 className ="slide__title"><div className="slide__box"></div><span className="slide__title-inner">Omismo</span></h3>
						<h4 className="slide__subtitle"><div className="slide__box"></div><span className="slide__subtitle-inner">Made at Wibicom</span></h4>
						<a className="slide__explore"><span className="slide__explore-inner">Explore</span></a>
					</div>
				...
				<div className="slide">
					<div className="slide__img-wrap">
						<div className="slide__img img3"></div>
						<div className="slide__img-reveal"></div>
					</div>
					<div className="slide__title-wrap">
						<h3 className="slide__title"><div className="slide__box"></div><span className="slide__title-inner">Becentral</span></h3>
						<h4 className="slide__subtitle"><div className="slide__box"></div><span className="slide__subtitle-inner">Made at Becode    </span></h4>
						<Link className="slide__explore" to='/becentral'><span className="slide__explore-inner">Explore</span></Link>
					</div>
